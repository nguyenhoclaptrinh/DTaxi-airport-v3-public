# Đặc tả Schema Dữ liệu Kịch bản (Scenario JSON v2)
...
---
> [!TIP]
> Việc chia nhỏ `path` thành nhiều điểm tọa độ sẽ giúp máy bay di chuyển bám sát các đường lăn thực tế trên sơ đồ sân bay.
